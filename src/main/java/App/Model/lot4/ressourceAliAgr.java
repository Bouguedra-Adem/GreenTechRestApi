...
@Entity
@Table(name = "ressource_alimentation_agreculture")
public class ressourceAliAgr {
	   @Id
	   ...
	   public ressourceAliAgr() {  
	   }

	public ressourceAliAgr(Integer id, String name, String description, String imageURL, boolean validite,
